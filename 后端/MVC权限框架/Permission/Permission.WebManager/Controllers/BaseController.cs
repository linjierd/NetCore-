...
namespace Permission.WebManager.Controllers
{
    ...
    public class BaseController : Controller
    {
        ...
        /// <returns></returns>
        public static bool LoginUserIsPermission(string moduleCode)
        {
           return AdminUserBll.LoginUserIsPermission(moduleCode, LoginUser);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static bool LoginUserIsPermissionUserRole()
        {
            return LoginUserIsPermission("user_manager_role_ddlist");
        } 
