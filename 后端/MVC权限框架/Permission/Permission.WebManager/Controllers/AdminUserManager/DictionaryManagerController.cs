    ...
    public class DictionaryManagerController :BaseController
    {
        ...
        public ActionResult GetList(SearchModel m)
        {
            var result = DictionaryTableBll.Instance.GetPageList(m).ToDataTablesObject().
               ...
               .Add("edit", c => "<a class=\"ml-5 bg_xiugai\" href=\"JavaScript:void(null)\" onclick=\"openUpdate('" + c.id + "')\" >编辑</a>")
               ).GetDataTableJson(m);
            return Json(result);
        }
        /// <summary>
        ...
        public ActionResult Detail(int  id=0)
        {
            ...
            else
            {
                ...
                DictionaryTableDb model = DictionaryTableBll.Instance.GetModel(id);
